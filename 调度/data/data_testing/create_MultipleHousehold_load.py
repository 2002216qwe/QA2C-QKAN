...
household_data1 = pd.read_csv(input_folder + 'consumer-00000007_glimpse_TEST_year.csv')
household_data2 = pd.read_csv(input_folder + 'consumer-00000008_glimpse_TEST_year.csv')
household_data3 = pd.read_csv(input_folder + 'consumer-00000009_glimpse_TEST_year.csv')
household_data4 = pd.read_csv(input_folder + 'consumer-00000010_glimpse_TEST_year.csv')
