...
px.area(VPP_table["household_power"], title=('Households power'), color_discrete_sequence=["red"]).update_layout(yaxis_title="kW", xaxis_rangeslider_visible=True, xaxis_range=["2018-06-01 00:00:00", "2018-07-01 00:00:00"])