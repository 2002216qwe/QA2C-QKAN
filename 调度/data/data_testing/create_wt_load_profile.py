...
wt_data = pd.read_csv(input_folder + 'ninja_wind_52.5170_13.3889_corrected_2020_MERRA_Berlin.csv')
...
wt_data_ = wt_data_15.loc['2020-01-01 00:00:00':'2021-01-01 00:00:00']
wt_data_.tail()

wt_data_csv = wt_data_.to_csv(output_folder + 'WT_load_2020_profile.csv', index = True)
#wt_data_.iplot(title='WT wind power', yTitle='kW', colors='#3aa2cd')
px.line(wt_data_["wind_power"], title=('WT wind power'), color_discrete_sequence=["#3aa2cd"]).update_layout(yaxis_title="kW", xaxis_rangeslider_visible=True, xaxis_range=["2020-06-01 00:00:00", "2020-07-01 00:00:00"])