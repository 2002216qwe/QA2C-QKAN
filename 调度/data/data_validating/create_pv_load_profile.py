...
pv_data = pd.read_csv(input_folder + 'ninja_pv_52.5170_13.3889_corrected_2018_MERRA_Berlin.csv')
...
pv_data_ = pv_data_15.loc['2018-01-01 00:00:00':'2019-01-01 00:00:00']
pv_data_.info()

pv_data_csv = pv_data_.to_csv(output_folder + 'PV_load_2018_profile.csv', index = True)
#pv_data_.iplot(title='PV Solar power', yTitle='kW')
px.line(pv_data_["solar_power"], title=('PV Solar power'), color_discrete_sequence=["orange"]).update_layout(yaxis_title="kW", xaxis_rangeslider_visible=True, xaxis_range=["2018-06-01 00:00:00", "2018-07-01 00:00:00"])
